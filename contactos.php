...
<div class="divderecha">
	...
	<table class="tablacentro">
		...
		<tr>
			<td><hr>Redes Sociales<br>
				<div id="divredes"class="social">
					<a href="#" title="Facebook"><img src="img/icon_facebook.png"></a>
		            <a href="#" title="Gmail"><img src="img/icon_gmail.png"></a>
		            <a href="#" title="Google +"><img src="img/icon_googlemas.png"></a>
		            <a href="#" title="Twitter"><img src="img/icon_twitter.png"></a>
